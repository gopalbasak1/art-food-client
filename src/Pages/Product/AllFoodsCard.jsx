...
const AllFoodsCard = ({ product }) => {
  ...
  return (
    ...
    <div className="w-2/3 p-4 md:p-4 h-[180px]">
        ...
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Category: {foodCategory} </p>

        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Quantity: {quantity}</p>
